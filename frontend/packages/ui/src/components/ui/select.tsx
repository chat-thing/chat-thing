  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon
        render={
          <ChevronDownIcon phosphor="CaretDownIcon" className="text-muted-foreground size-4 pointer-events-none" />
        }
      />
    </SelectPrimitive.Trigger>
  )
...
function SelectItem({
  ...
  return (
    ...
    >
      ...
      >
        <CheckIcon phosphor="CheckIcon" className="pointer-events-none" />
      </SelectPrimitive.ItemIndicator>
    </SelectPrimitive.Item>
  )
}
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpArrow
      ...
      {...props}
    >
      <ChevronUpIcon phosphor="CaretUpIcon" />
    </SelectPrimitive.ScrollUpArrow>
  )
}
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownArrow
      ...
      {...props}
    >
      <ChevronDownIcon phosphor="CaretDownIcon" />
    </SelectPrimitive.ScrollDownArrow>
  )
}
